...
/** source: C:\xampp\htdocs\eclipse\app\Presentation\Tag/default.latte */
final class Template_0803e582bb extends Latte\Runtime\Template
{
	public const Source = 'C:\\xampp\\htdocs\\eclipse\\app\\Presentation\\Tag/default.latte';
...
';
			foreach ($tagsWithCounts as $tag) /* line 30 */ {
				echo '                                    <tr>
                                        <td>
                                            <a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-detail', [$tag['slug']])) /* line 33 */;
				...
				echo '</td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-detail', [$tag['slug']])) /* line 41 */;
				echo '" class="btn btn-outline-primary">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-edit', [$tag['id']])) /* line 44 */;
				echo '" class="btn btn-outline-secondary">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-delete', [$tag['id']])) /* line 47 */;
...
';
				foreach ($tagCloud as $tag) /* line 92 */ {
					echo '                                <a href="';
					echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-detail', [$tag['slug']])) /* line 93 */;
					echo '" 
...
';
				foreach ($trendingTags as $tag) /* line 111 */ {
					echo '                                <a href="';
					echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-detail', [$tag['tag']->slug])) /* line 112 */;
...
';
        ...
        <i class="fas fa-info-circle me-1"></i> Žádné tagy nebyly nalezeny. <a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link('Tag-add')) /* line 125 */;
